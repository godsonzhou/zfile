...
namespace zfile
{
	...
	public class FtpFileSource : FileSource
	{
		...
		{
			return new FtpCopyOutOperation(this, targetFileSource, sourceFiles.Path.Contains('\\') ? FileSourceUtil.FileEntryListToFtpFileEntries(sourceFiles.List) : sourceFiles, targetPath);
		}
