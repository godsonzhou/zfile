...
//		leftFilePathBox = new TextBox { Dock = DockStyle.Top, ReadOnly = true };
...
//		leftSplit.Panel2.Controls.Add(leftContent);
//		leftPanel.Controls.Add(leftSplit);

//		// 右侧面板
//		var rightPanel = new Panel { Dock = DockStyle.Fill };
//		rightFilePathBox = new TextBox { Dock = DockStyle.Top, ReadOnly = true };
...
//		rightSplit.Panel2.Controls.Add(rightContent);
...
//		// 添加滚动同步事件
//		leftContent.VScroll += (s, e) => SyncScroll(leftContent, rightContent);
//		rightContent.VScroll += (s, e) => SyncScroll(rightContent, leftContent);
//		leftContent.HScroll += (s, e) => SyncHorizontalScroll(leftContent, rightContent);
//		rightContent.HScroll += (s, e) => SyncHorizontalScroll(rightContent, leftContent);
...
//				rightLineNumbers.AppendText($"{lineNum}\n");
//			}
//			else
//			{
...
//			{
//				if (leftDiffLines[i].Type == ChangeType.Deleted ||
//					rightDiffLines[i].Type == ChangeType.Inserted)
//				{
//					diffCount++;
//				}
//			}
...
//		if (!string.IsNullOrEmpty(leftFilePath))
//			CompareFiles();
//	}
