...
namespace zfile
{
	public class SearchforDialog : Form
	{
		...
		private void InitializePluginsTab()
		{
			...
			pluginsList.Columns.Add("插件", 150);
			pluginsList.Columns.Add("描述", 400);

			addPluginButton = new Button { Text = "添加插件(M)", Location = new Point(10, 205), Width = 100 };
			removePluginButton = new Button { Text = "减少插件(E)", Location = new Point(120, 205), Width = 100 };

			// 添加控件到插件选项卡
			pluginsTab.Controls.AddRange(new Control[] {
				usePluginsCheckBox, pluginsList, addPluginButton, removePluginButton
			});
		}
		...
		{
			// 匹配规则区域
			var matchRuleLabel = new Label { Text = "匹配规则：", Location = new Point(10, 15), AutoSize = true };
			andRuleRadioButton = new RadioButton { Text = "与(全部匹配)(A)", Location = new Point(100, 15), AutoSize = true, Checked = true };
			orRuleRadioButton = new RadioButton { Text = "或(部分匹配)(O)", Location = new Point(250, 15), AutoSize = true };

			// 规则设置区域
			var pluginLabel = new Label { Text = "插件(P)：", Location = new Point(10, 45), AutoSize = true };
			...
			var attributeLabel = new Label { Text = "属性：", Location = new Point(10, 75), AutoSize = true };
			...
			var operatorLabel = new Label { Text = "操作符：", Location = new Point(10, 105), AutoSize = true };
			...
			operatorComboBox.Items.AddRange(new object[] { "包含", "等于", "大于", "小于", "开始于", "结束于" });
			operatorComboBox.SelectedIndex = 0;

			var valueLabel = new Label { Text = "值：", Location = new Point(10, 135), AutoSize = true };
			valueTextBox = new TextBox { Location = new Point(100, 132), Width = 300 };

			addRuleButton = new Button { Text = "增加规则(M)", Location = new Point(10, 165), Width = 100 };
			removeRuleButton = new Button { Text = "减少规则(E)", Location = new Point(120, 165), Width = 100 };
			...
			// 添加控件到规则选项卡
			rulesTab.Controls.AddRange(new Control[] {
				matchRuleLabel, andRuleRadioButton, orRuleRadioButton,
				pluginLabel, pluginComboBox, attributeLabel, attributeComboBox,
				operatorLabel, operatorComboBox, valueLabel, valueTextBox,
