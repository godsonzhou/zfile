...
namespace zfile
{
    ...
    public class PackInfoDialog : Form
    {
        ...
        private void InitializeData()
        {
            ...
            // 设置文件日期和时间
            if (_file.ModificationTime.HasValue)
            {
                lblPackedDate.Text = _file.ModificationTime.Value.ToShortDateString();
                lblPackedTime.Text = _file.ModificationTime.Value.ToShortTimeString();
            }
