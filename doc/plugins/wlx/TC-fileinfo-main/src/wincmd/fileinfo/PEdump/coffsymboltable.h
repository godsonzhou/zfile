...
public:
	...
	SHORT GetSectionNumber() { return m_pSymbolData ? m_pSymbolData->SectionNumber : 0; }
	WORD  GetType() { return m_pSymbolData ? m_pSymbolData->Type : 0; }
	PSTR  GetTypeName();
	BYTE  GetStorageClass() { return m_pSymbolData ? m_pSymbolData->StorageClass : 0; }
	PSTR  GetStorageClassName();
	BOOL  GetNumberOfAuxSymbols() { return m_pSymbolData ? m_pSymbolData->NumberOfAuxSymbols : 0; }
...
public:
	...
	PCOFFSymbol GetNearestSymbolFromRVA( ULONGLONG rva, BOOL fExact );
